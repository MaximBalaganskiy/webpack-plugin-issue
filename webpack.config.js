...
module.exports = (env, {production, analyze, tests, hmr, port, host } = {}) => {
    ...
    return {
        ...
        module: {
            rules: [
                ...
                { test: /\.js$/, enforce: 'pre', use: ['source-map-loader'], include: [/@aurelia-mdc-web/] },
                /**
                ...
                { test: /\.css$/, issuer: [{ not: /\.html$/i }], use: [{ loader: MiniCssExtractPlugin.loader }, ...cssLoaders] },
